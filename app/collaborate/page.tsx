    ...
    <div>
        ...
        <div className="bg-light-green w-full">
          <div className="flex justify-center flex-wrap items-center py-16 px-8 lg:p-10 gap-10 lg:gap-26 flex-grow">
            ...
            <div className=" lg:max-w-md">
              <h2 className=" font-heading text-2xl font-extrabold mb-3">{data.work_title}</h2>
      ...
      <section>
        <div className="w-full">
          <div className="flex justify-center flex-wrap items-center py-16 px-8 lg:p-16 gap-10 lg:gap-26 flex-grow">
            <div className="lg:max-w-md">
              <h2 className="font-heading text-2xl font-extrabold mb-3">{data.career_title}</h2>
      ...
      <section>
        <div className="bg-light-green w-full">
          <div className="flex justify-center flex-wrap items-center py-16 px-8 lg:p-10 gap-10 lg:gap-26 flex-grow">
            <div className=" lg:max-w-md">
              <h2 className="font-heading text-2xl font-extrabold mb-3">{data.collaborate_title}</h2>
